...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Rentify is a smart and reliable platform for renting tools with ease and flexibility.">
    ...
    <!-- Title -->
    <title>Rentify - Smart Tool Rental Platform</title>
        ...
        <div class="search-form d-flex align-items-center">
            <div class="container">
                <form id="searchForm" onsubmit="return false;" class="position-relative">
                    <input type="search" id="searchFormInput" placeholder="Search for a product or category"
                        autocomplete="off">
                    <button type="submit"><i class="icon_search"></i></button>
                    <ul id="liveSearchResults" class="list-group position-absolute w-100 bg-white shadow mt-1"
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between align-items-center" id="robertoNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <!-- Nav Start -->
                            <div class="classynav d-flex justify-content-between align-items-center w-100"
                                style="height: 80px;">
                                ...
                                <div class="d-none d-lg-flex align-items-center gap-3">
                                            ...
                                            <li class="position-relative">
                                                ...
                                                <ul class="dropdown">
                                                    @foreach ($categories as $category)
                                                        <li>
                                                            <a
                                                                href="{{ route('products.by.category', ['id' => $category->id]) }}">
                                                                - {{ $category->name }}
                                                            </a>
                                                        </li>
                                                    @endforeach
                                    ...
                                    @auth
                                        @if (auth()->user()->user_type === 'user')
                                            <a href="#" class="navbar-feedback-btn" data-bs-toggle="modal"
                                        ...
                                        <div class="chat-wrapper position-relative">
                                            <a href="{{ route('chat.index') }}"
                                                ...
                                                <span id="chat-unread-count"
                                                    class="badge bg-danger position-absolute top-0 start-100 translate-middle rounded-pill d-none">
                                                    0
                                                </span>
                                            </a>
                                        </div>
                                ...
                                <div class="mobile-menu-content d-lg-none w-100">
                                    ...
                                    <div class="mobile-actions d-flex flex-column gap-3">
                                        @auth
                                            @if (auth()->user()->user_type === 'user')
                                                <a href="#" class="navbar-feedback-btn" data-bs-toggle="modal"
                                                    data-bs-target="#feedbackModal">Leave Feedback</a>
                                            @endif
                                ...
                                <div class="profile-dropdown d-flex align-items-center gap-2"
                                    ...
                                    @auth
                                        ...
                                        <!-- Dropdown Menu -->
                                        <div id="profileMenu"
                                            class="dropdown-content hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow z-[9999]">

                                            <a href="{{ route('profile') }}"
                                                style="display: block;width: 100%; padding: 8px;">👤 Profile</a>

                                            @if (Auth::user()->user_type === 'admin')
                                                <a href="{{ route('admin.dashboard') }}"
                                                    style="display: block; width: 100%; padding: 8px;">🔧 Admin
                                                    Dashboard</a>
                                            @elseif (Auth::user()->user_type === 'merchant')
                                                <a href="{{ route('merchant.dashboard') }}"
                                                    style="display: block; width: 100%;  padding: 8px;">🛒 Merchant
                                                    Dashboard</a>
                                            @endif

                                            @if (auth()->user()->user_type === 'user')
                                                <a href="{{ route('user.activity') }} "
                                                    style="display: block; width: 100%; padding: 8px;">📋 My Activity</a>
                                                <button type="button" data-bs-toggle="modal"
                                                    data-bs-target="#generalReportModal"
                                                    style="
                                                display: block;
                                                width: 100%;
                                                padding: 8px;
                                    ...
                                    @guest
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('login') }}"
                                                class="btn btn-sm btn-outline-primary">Login</a>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="subject" class="form-control"
                                placeholder="e.g. Bug in booking system">
                        </div>
