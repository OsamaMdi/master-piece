...
<div class="products-grid">
    ...
    <div class="product-card">
        <div class="product-image">
            ...
            @else
                ...
                <p class="no-image-text">This product has no image</p>
            @endif
        </div>

        <div class="product-details">
            <h3 class="product-name">{{ $product->name }}</h3>
            <p class="product-price">Rent for {{ number_format($product->price, 2) }} JOD/day</p>
    ...
    <div class="empty-state">
        ...
        <p>Start renting your tools now!</p>
    </div>
    @endforelse
</div>
