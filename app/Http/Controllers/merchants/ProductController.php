...
class ProductController extends Controller
{
    public function index()
    {
        ...
        $products = Product::with(['user', 'category', 'images', 'reviews', 'reservations'])->paginate(12);
    ...
    public function store(Request $request)
    {
        try {
            ...
            $product = Product::create([
                ...
                'status' => 'available',
                'user_id' => 1, // ثابت أو حسب المستخدم الحالي
    ...
    public function showReservations(string $productId)
    {
